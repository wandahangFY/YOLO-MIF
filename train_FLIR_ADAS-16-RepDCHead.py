...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/v8_NEU-DET/yolov8-C2f-WDBB-backbone-effhead_3dbb.yaml', help='model.yaml path')
    ...
    parser.add_argument('--data', type=str, default='ultralytics/datasets/FLIR_ADAS_16.yaml', help='data yaml path')
    ...
    parser.add_argument('--project', type=str, default= 'runs/train/RepDCHead/FLIR_ADAS-16', help='save to project/name')
    parser.add_argument('--name', type=str, default='FLIR_ADAS-yolov8-C2f-WDBB-backbone-effhead_3dbb-no_pre-RIR-SimOTMBBS-', help='save to project/name')
    ...
    parser.add_argument('--use_simotm', type=str, choices=['Gray2BGR', 'SimOTM', 'SimOTMBBS', 'Gray','SimOTMSSS'],
