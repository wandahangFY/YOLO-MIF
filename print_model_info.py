...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/v8_NEU-DET/yolov8-C2f-DBB-backbone-DLAFusionSim.yaml', help='model.yaml path')
    ...
    parser.add_argument('--imgsz', type=int, default=224, help='size of input images as integer')
    parser.add_argument('--cache', type=str, nargs='?', const='ram', help='image --cache ram/disk')
    parser.add_argument('--device', type=str, default='', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--workers', type=int, default=2, help='max dataloader workers (per RANK in DDP mode)')
    parser.add_argument('--project', type=str, default= 'runs/train/NEU-DET/NEU-DET', help='save to project/name')
    parser.add_argument('--name', type=str, default='NEU-DET-yolov8-DBB-bifpn_no_pre-SimOTM-CIoU', help='save to project/name')
    ...
    parser.add_argument('--info', action="store_true", default=True, help='model info verbose')
